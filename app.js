...
// body.style.width = '95%';
// body.style.maxWidth = '1700px';
// body.style.margin = '0 auto';

const maxNum = parseInt(prompt('How many Pokemons would you like to see?'));

const h1 = document.querySelector('h1');
h1.innerHTML = `Look at my <span id="myPokemon"></span> Pokemons!`;

const myPokemon = document.querySelector('#myPokemon');
myPokemon.innerHTML = `${maxNum}`;
...
for (let i = 1; i <= maxNum; i++) {
    ...
    pokeNum.innerText = `# ${i}`;
    pokeCard.append(pokeNum);

    const pokeName = document.createElement('p');
    pokeName.innerText = `${pokeNames[i - 1]}`;
